/// Like opus_custom from [opus_dart](https://pub.dev/packages/opus_dart), but uses the internal libopus on Android and iOS.
library opus_custom;
export 'package:opus_dart/wrappers/opus_custom.dart' hide init;

import 'dart:ffi';
import 'package:opus_dart/wrappers/opus_custom.dart' as opus_custom show init;
...
void init([DynamicLibrary other]) => opus_custom.init(Loader.loadInternal(other: other));