/// Like opus_repacketizer from [opus_dart](https://pub.dev/packages/opus_dart), but uses the internal libopus on Android and iOS.
library opus_repacketizer;
export 'package:opus_dart/wrappers/opus_repacketizer.dart' hide init;

import 'dart:ffi';
import 'package:opus_dart/wrappers/opus_repacketizer.dart' as opus_repacketizer show init;
...
void init([DynamicLibrary other]) => opus_repacketizer.init(Loader.loadInternal(other: other));