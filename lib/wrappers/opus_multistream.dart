/// Like opus_multistream from [opus_dart](https://pub.dev/packages/opus_dart), but uses the internal libopus on Android and iOS.
library opus_multistream;
export 'package:opus_dart/wrappers/opus_multistream.dart' hide init;

import 'dart:ffi';
import 'package:opus_dart/wrappers/opus_multistream.dart' as opus_multistream show init;
...
void init([DynamicLibrary other]) => opus_multistream.init(Loader.loadInternal(other: other));